...
schedule.every().day.at(daylightsavingsunset).do(LampNaastBankAan)
schedule.every().day.at(daylightsavingsunset).do(TvMeubelLampAan)
schedule.every().day.at(daylightsavingsunset).do(BuitenLichtAan)
